...
title('Energy Efficiency With Minimum Mean Square Error (M-MMSE)');
...
ylabel('Number of BS antennas (M)');
zlabel('EE [Mbit/Joule]');
title('Energy Efficiency WIth RZF(Reguralized Zero-forcing');
...
ylabel('Number of BS antennas (M)');
zlabel('EE [Mbit/Joule]');
title('Energy Efficiency With Maximum-ration Combining MRC')
